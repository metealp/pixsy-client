...
export default view((props) => {
    ...
    return (
        <Layout className='mainLayoutContainer'>
            <Header className='layoutHeader'>
                <Row gutter={16}>
                    <Col className="gutter-row" span={2}>
                        <a href="/">
                            <Image
                                src='https://www.pixsy.com/wp-content/uploads/2018/09/Asset-2@4x.png'
            ...
            <Layout className='innerLayoutContainer'>
                {sideNav}
                <Content>{content}</Content>
            </Layout>
            <Footer className='layoutFooter'>Designed & Developed by Mete Alp Kizilcay with <HeartFilled /> for Pixsy</Footer>
        </Layout>
    )
})
